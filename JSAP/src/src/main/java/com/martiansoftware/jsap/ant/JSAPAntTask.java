 ...
 *
 * <p><code>
 * &lt;taskdef name="jsap" classname="JSAPAntTask"
 ...
 *
 * <ul>
 * <li><b>switch</b> - declares a Switch (Switch).</li>
 ...
 * assuming
 * it is a subclass of PropertyStringParser.</p>
 *
 * <h2>Example</h2>
 *
 * <pre>
* & lt;taskdef name = "jsap" classname = "JSAPAntTask"
 *      classpath="${build}"/&gt;
 *
...
public class JSAPAntTask extends Task {
     ...
     * will be written.
     * @throws com.martiansoftware.jsap.JSAPException if there are any problems with the specified
     * configuration.
     */
    ...
    private void createJavaFile(
        ...
        out.println("  */");
        out.println();
        out.println("import JSAP;");
        out.println("import JSAPException;");
        if (containsSwitches) {
            out.println("import Switch;");
        }
        if (containsFlaggedOptions) {
            out.println("import FlaggedOption;");
        }
        if (containsUnflaggedOptions) {
            out.println("import UnflaggedOption;");
        }
        if (hasProperties) {
            out.println(
                "import PropertyStringParser;");
        }
        out.println();
